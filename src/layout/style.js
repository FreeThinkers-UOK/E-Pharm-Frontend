...
const Div = Styled.div`
    ...
    header{
        ...
        ${({ darkMode }) => (darkMode ? `background: #068f70;` : '')};
        z-index: 999;

        .ant-btn-link{
            ${({ darkMode }) =>
              darkMode ? `background: #068f70;border-color: #068f70;color: #7D808D !important` : ''};
        }
    ...
    .customizer-trigger{
        ...
        z-index: 999;
        box-shadow: 0 10px 15px rgba(#078367,.20);
        &.show{
    ...
    .certain-category-search-wrapper{
        ${({ darkMode, theme }) =>
          darkMode ? `${!theme.rtl ? 'border-right' : 'border-left'}: 1px solid #068f70;` : ''};
         @media only screen and (max-width: 767px){
            padding: 0 15px;
        }
        input{
...
const SmallScreenAuthInfo = Styled.div`
        ${({ darkMode }) => (darkMode ? `background: #068f70;` : 'background: #fff')};
        width: 100%;
        position: fixed;
            ...
            li{
                ...
                &.has-subMenu{
                    >a{
                        ...
                        &.active{
                            &:before{
                                ${({ theme }) => (theme.darkMode ? `color: #fff;` : 'color: #078367')};
                            }
                        }
                    }
                }
