...
const Banner2 = () => {
  return (
    <BannerWrapper>
      <Cards className="mb-70" bodyStyle={{ background: '#078367', borderRadius: '10px', minHeight: '270px' }} headless>
        <Figure2>
...
const Banner3 = () => {
  return (
    <BannerWrapper>
      <Cards  bodyStyle={{ borderRadius: '10px', minHeight: '270px', background: '#078367' }} headless>
        <Figure3>
...
const Banner4 = () => {
  return (
    <BannerWrapper>
      <Cards bodyStyle={{ background: '#4DB6A', borderRadius: '10px', minHeight: '270px' }} headless>
